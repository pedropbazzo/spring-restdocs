 ...
 * @since 2.0.0
 */
public class WebFluxSnippetConfigurer extends
		SnippetConfigurer<WebFluxRestDocumentationConfigurer, WebFluxSnippetConfigurer>
		implements ExchangeFilterFunction {

	WebFluxSnippetConfigurer(WebFluxRestDocumentationConfigurer parent) {
		super(parent);
	}
