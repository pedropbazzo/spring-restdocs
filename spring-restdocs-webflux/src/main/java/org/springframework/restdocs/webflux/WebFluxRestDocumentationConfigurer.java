 ...
 * @since 2.0.0
 */
public class WebFluxRestDocumentationConfigurer extends
		RestDocumentationConfigurer<WebFluxSnippetConfigurer, WebFluxRestDocumentationConfigurer>
		implements ExchangeFilterFunction {

	private final WebFluxSnippetConfigurer snippetConfigurer = new WebFluxSnippetConfigurer(
			this);
	...
	WebFluxRestDocumentationConfigurer(RestDocumentationContextProvider contextProvider) {
		this.contextProvider = contextProvider;
	}

	@Override
	public WebFluxSnippetConfigurer snippets() {
